...
if __name__ == '__main__':
    ...
    print(supervisor_data['emp_pos'].unique())
    print(supervisor_data['emp_job'].unique())
    print(supervisor_data['emp_site'].unique())
    supervisor_data = clean_supervisor_data(supervisor_data)
    incidents = pd.read_csv("../resources/incidents.csv")
